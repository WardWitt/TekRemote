...
class DLLOPT Pdu
{
 public:
   ...
   */
  bool get_notify_id(Oid &iD) const { iD = notify_id; return (notify_id.len() == iD.len()); };
   ...
   * @return true if the set succeeded.
   */
  bool set_notify_enterprise(const Oid &e) { notify_enterprise = e; return (notify_enterprise.len() == e.len()); };
   ...
   * @return true if the get succeeded.
   */
  bool get_notify_enterprise(Oid & e) const { e = notify_enterprise;  return (notify_enterprise.len() == e.len()); };
